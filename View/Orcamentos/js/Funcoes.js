     ...
     codCliente: $("#codClienteVenda").val()}, function(data){
        ...
        if (data[0]){   
            MontaDadosCliente(data[1][0].COD_CLIENTE, data[1][0].DSC_CLIENTE, data[1][0].NRO_CPF, data[1][0].NRO_CNPJ, data[1][0].NRO_TELEFONE_CONTATO,
                              data[1][0].NRO_TELEFONE_CELULAR, data[1][0].TXT_ENDERECO, '', '0', '0');
    ...
    {method:'CarregaDadosVenda',
     codVenda: $("#codVenda").val()}, function(data){
        ...
        if (data[0]){
            ...
            MontaDadosCliente(data[1][0].COD_CLIENTE, data[1][0].DSC_CLIENTE, data[1][0].NRO_CPF, data[1][0].NRO_CNPJ, data[1][0].NRO_TELEFONE_CONTATO,
                              data[1][0].NRO_TELEFONE_CELULAR, data[1][0].TXT_ENDERECO, data[1][0].DSC_VEICULO, data[1][0].VLR_VENDA, data[1][0].VLR_DESCONTO);
...
function MontaProdutosOrcamento(data){
    var dadosProdutos = '<table width="100%" class="TabelaConteudo" cellpadding="0" cellspacing="0">';
    var corLinha = "white";
    dadosProdutos += '<tr>';
    dadosProdutos += '<td colspan="5">';
    dadosProdutos += '<table width="100%">';
    dadosProdutos += '<tr>';
    dadosProdutos += '<td class="TDTituloCabecalho">Produtos deste Orçamento</td>';
    dadosProdutos += '</tr>';
    dadosProdutos += '</table>';
    dadosProdutos += '</td>';
    dadosProdutos += '</tr> ';   
    dadosProdutos += "<tr>";
    dadosProdutos += '<td class="TDTitulo">Nome</td>';
    dadosProdutos += '<td class="TDTitulo">Qtd.</td>';
    dadosProdutos += '<td class="TDTitulo">Desconto</td>';
    dadosProdutos += '<td class="TDTitulo">Valor</td>';
    dadosProdutos += '<td class="TDTitulo">Total</td>';
    dadosProdutos += "</tr>";
    if (corLinha=="white"){
        corLinha="E8E8E8";
    }else{
    ...
    for (i=0; i<data.length;i++){
        dadosProdutos += '<tr bgcolor="'+corLinha+'" class="trcor">';
