...
$dadosEntrada = (unserialize(urldecode($_POST['dadosEntrada'])));
$dadosProdutosEntrada = (unserialize(urldecode($_POST['dadosProdutosEntrada'])));
?>
<html>
    <head>
                            ...
                            <td>
                                <table width="100%" class="TabelaCabecalho">
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $dadosEntrada[0]['DSC_FORNECEDOR'];?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="TDTitulo">
                            ...
                            <td>
                                <table width="100%" class="TabelaConteudo" cellpadding="0" cellspacing="2">
                                    ...
                                    <tr bgcolor="<?php echo $corLinha?>" class="trcor">
                                        ...
                                        <td align="right">
                                            R$ <?php echo number_format($dadosProdutosEntrada[$i]['VLR_UNITARIO'],2)?>
                                        </td>
                                        <td align="right">
                                            <?php echo $dadosProdutosEntrada[$i]['QTD_ENTRADA']?>
                                        </td>
                                        <td align="right">
                                            R$ <?php echo number_format($dadosProdutosEntrada[$i]['VALOR_TOTAL'],2)?>
                                        </td>
                                    </tr>
                                    <?php $vlrTotal = $vlrTotal+$dadosProdutosEntrada[$i]['VALOR_TOTAL'];
                                    $i++;
                                    }
                                    ?>
                                    <tr>
                                        <td colspan="4" align="right" class="TDTitulo">
                                            Total
                                        </td>
                                        <td align="right">
                                        R$ <?php echo number_format($vlrTotal,2)?>
