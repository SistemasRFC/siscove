...
include_once("../../Form/Relatorios/RelatoriosFluxoCaixaForm.php");
class RelatoriosFluxoCaixaDao extends BaseDao
{
    function RelatoriosFluxoCaixaDao(){
        $this->conect();
    }
    /**
    ...
    function BuscaMovimentacoes($codClienteFinal){
        $form = new RelatoriosFluxoCaixaForm();
